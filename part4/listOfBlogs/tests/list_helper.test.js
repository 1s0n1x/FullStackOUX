...
describe('The ... of a list', () => {
  ...
  test('favorite blog', () => {
    let expectedResult = { title: blogs[2].title, author: blogs[2].author, likes: blogs[2].likes }
  ...
  test('most liked', () => {
    let expectedResult = { author: "Edsger W. Dijkstra", likes: 17 };
